...
OPERATION_CONTRACTS = (
    ...
    operation("/support/cases/{caseId}/verification-sessions", "post", "createSupportVerificationSession", "bearerAuth", (400, 401, 410), "SupportCaseId", "IdempotencyKey", response_schemas=(ResponseSchemaContract("410", "Error"),), response_headers=no_store_header(410)),
    support_query("/support/verification-sessions/{sessionId}", "getSupportVerificationSession", "VerificationSessionId"),
    operation("/support/verification-sessions/{sessionId}/challenges", "post", "issueSupportVerificationChallenge", "bearerAuth", (400, 401, 410), "VerificationSessionId", "IdempotencyKey", response_schemas=(ResponseSchemaContract("410", "Error"),), response_headers=no_store_header(410)),
    operation("/support/verification-challenges/{challengeId}/verifications", "post", "verifySupportVerificationChallenge", "bearerAuth", (400, 401, 410), "VerificationChallengeId", "IdempotencyKey", response_schemas=(ResponseSchemaContract("410", "Error"),), response_headers=no_store_header(410)),
    ...
    operation("/stores/{storeId}/support-order-change-authorizations", "post", "createSupportOrderChangeAuthorization", "merchantSession", (201, 400, 401, 403, 404, 409, 503), "StoreId", "IdempotencyKey", "MerchantCsrfToken"),
    operation("/stores/{storeId}/support-order-change-requests/{requestId}", "get", "getStoreSupportOrderChangeRequest", "merchantSession", (200, 401, 403, 404, 409, 503), "StoreId", "SupportActionRequestId"),
    support_query("/support/cases/{caseId}/orders/{orderId}", "getSupportOrderContext", "SupportCaseId", "OrderId", response_schema="SupportOrderContextResource"),
    support_query("/support/action-requests/{requestId}/workflow", "getSupportOrderWorkflow", "SupportActionRequestId", response_schema="SupportOrderWorkflowResource"),
    ...
    support_query("/support/compensation-coupon-templates", "listSupportCompensationCouponTemplates"),
...
SCHEMA_CONTRACTS = (
    ...
    SchemaContract("SupportActionRequestResource", properties=("actionPayloadDigest", "evidenceDigest", "approvalSteps", "terminalExecutionId", "terminalResolutionId", "terminalCompensationId", "terminalProfileChangeId"), forbidden_properties=("reason", "rawPayload", "proof", "otp", "token")),
    ...
    SchemaContract("SupportCompensationRequestState", enum=("AWAITING_APPROVAL", "READY_FOR_EXECUTION", "BENEFIT_ISSUED", "NOTIFICATION_RETRY", "NOTIFICATION_ACCEPTED", "NOTIFICATION_SKIPPED")),
    ...
    SchemaContract("SupportActionType", enum=("ORDER_CANCELLATION", "PICKUP_RESCHEDULE", "POST_ACCEPTANCE_RESOLUTION", "GOODWILL_COMPENSATION", "PROFILE_CHANGE")),
