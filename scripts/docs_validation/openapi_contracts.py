...
OPERATION_CONTRACTS = (
    ...
    operation("/support/cases/{caseId}/verification-sessions", "post", "createSupportVerificationSession", "bearerAuth", (400, 401, 410), "SupportCaseId", response_schemas=(ResponseSchemaContract("410", "Error"),), response_headers=no_store_header(410)),
    support_query("/support/verification-sessions/{sessionId}", "getSupportVerificationSession", "VerificationSessionId"),
    operation("/support/verification-sessions/{sessionId}/challenges", "post", "issueSupportVerificationChallenge", "bearerAuth", (400, 401, 410), "VerificationSessionId", response_schemas=(ResponseSchemaContract("410", "Error"),), response_headers=no_store_header(410)),
    operation("/support/verification-challenges/{challengeId}/verifications", "post", "verifySupportVerificationChallenge", "bearerAuth", (400, 401, 410), "VerificationChallengeId", response_schemas=(ResponseSchemaContract("410", "Error"),), response_headers=no_store_header(410)),
