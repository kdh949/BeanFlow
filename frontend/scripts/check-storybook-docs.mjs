...
const expectedDocs = new Set([
  ...
  "patterns-navigation-workspace-frame--docs",
  "patterns-store-merchant-workspace-shell--docs",
  "patterns-support-support-workspace-shell--docs",
  "patterns-operations-operations-workspace-shell--docs",
  "patterns-layout-reference-pages--docs",
