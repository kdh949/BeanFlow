...
async function retryPrepared(canvas: Parameters<NonNullable<Story["play"]>>[0]["canvas"]) {
  const retry = await canvas.findByRole("button", { name: "같은 요청으로 결과 확인" });
