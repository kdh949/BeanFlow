...
export const StorePointPolicyEntry: Story = { play: async ({ canvas }) => { await userEvent.click(canvas.getByRole("tab", { name: "매장별 포인트" })); await expect(canvas.getByRole("searchbox", { name: "매장 이름 검색" })).toBeVisible(); } };
