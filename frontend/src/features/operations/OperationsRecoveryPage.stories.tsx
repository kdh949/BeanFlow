...
const meta = { title: "Pages/Operations/Recovery", component: OperationsRecoveryPage, tags: ["autodocs"], parameters: { a11y: { test: "error" }, routing: { path: "/ops/recovery", initialEntry: "/ops/recovery" }, msw: { handlers: [http.get("/api/v1/operations/point-adjustment-preparations/current", () => HttpResponse.json({ preparation: null })), http.get("/api/v1/operations/notification-delivery-recoveries", () => HttpResponse.json({ items: [], nextCursor: null })), http.get("/api/v1/operations/event-publication-recoveries", () => HttpResponse.json({ items: [], nextCursor: null }))] }, docs: { description: { component: "알림과 이벤트 전달의 수동 복구를 구분합니다. 예시 수치나 미연결 정산/감사 탭을 표시하지 않습니다." }, story: { inline: false, height: "850px" } } } } satisfies Meta<typeof OperationsRecoveryPage>;
