...
describe("CouponCampaignsPage", () => {
  it("creates a complete draft with a fixed coupon expiry", async () => {
    ...
    await userEvent.type(screen.getByLabelText("다운로드 시작 시각"), "2026-10-01T00:00:00+09:00");
    await userEvent.type(screen.getByLabelText("다운로드 종료 시각"), "2026-10-10T23:59:59+09:00");
    await userEvent.type(screen.getByLabelText("쿠폰 만료 시각"), "2026-10-31T23:59:59+09:00");
    ...
    expect(options.body).toMatchObject({ totalQuota: 100, couponExpiresAt: "2026-10-31T23:59:59+09:00" });
