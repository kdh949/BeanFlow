...
export const SignedIn: Story = {
  play: async ({ canvas }) => {
    ...
    await expect(canvas.getByRole("link", { name: "최근 주문한 매장" })).toHaveAttribute("href", "/app/recent-stores");
    await expect(canvas.getByRole("link", { name: "쿠폰 받기" })).toHaveAttribute("href", "/app/events");
