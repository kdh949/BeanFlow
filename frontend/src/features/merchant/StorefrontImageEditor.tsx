...
export function StorefrontImageEditor({ storeId, menuId, label, onBusyChange }: { storeId: string; menuId?: string; label: string; /** Prevent parent navigation while a draft or request exists. */ onBusyChange?: (busy: boolean) => void }) {
