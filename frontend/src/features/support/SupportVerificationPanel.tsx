...
export function SupportVerificationPanel({ caseId, links, disabled, locked = false, onBusyChange, onChange, initialActionScope = "PERSONAL_DATA_REVEAL" }: { initialActionScope?: Session["actionScope"]; caseId: string; links: components["schemas"]["SupportSubjectLink"][]; disabled: boolean; locked?: boolean; onBusyChange?: (busy: boolean) => void; onChange: (session: Session | null) => void }) {
