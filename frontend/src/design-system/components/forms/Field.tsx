...
export type TextFieldType = "text" | "email" | "tel" | "password" | "number" | "date" | "time" | "datetime-local";
...
/** Canonical controlled single-line field. Numeric, date, time, and local date-time values remain strings so empty input is never coerced. */
