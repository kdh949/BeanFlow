  ...
  http.get("/api/v1/stores/:storeId/menus", () => HttpResponse.json({ items: [
    {
      ...
      currency: "KRW",
      available: true,
      image: { url: "/demo/catalog/cafe-latte.webp", expiresAt: "2099-01-01T00:00:00Z" },
      options: [],
    },
    {
      ...
      currency: "KRW",
      available: true,
      image: { url: "/demo/catalog/caramel-macchiato.webp", expiresAt: "2099-01-01T00:00:00Z" },
      options: [],
    },
    {
      menuId: "20000000-0000-4000-8000-000000000003",
      name: "바닐라 라떼",
      displayCategory: "라떼",
      description: "달콤한 바닐라와 진한 에스프레소",
      basePriceKrw: 5_500,
      currency: "KRW",
      available: false,
      image: { url: "/demo/catalog/americano.webp", expiresAt: "2099-01-01T00:00:00Z" },
      options: [],
    },
    {
      menuId: "20000000-0000-4000-8000-000000000004",
      name: "크루아상",
      displayCategory: "베이커리",
      description: "겉은 바삭하고 속은 촉촉한 버터 크루아상",
      basePriceKrw: 3_200,
      currency: "KRW",
      available: true,
      image: { url: "/demo/catalog/bagel.webp", expiresAt: "2099-01-01T00:00:00Z" },
      options: [],
    },
  ] })),
    ...
    items: [
      ...
      },
      {
        store: {
          ...
          orderingAvailable: true,
          pickupAvailable: true,
          nextPickupWindow: { startsAt: "2026-08-15T03:35:00Z", endsAt: "2026-08-15T03:45:00Z" },
          customerDisplay: { ...customerDisplay, addressLine: "경기 성남시 분당구 판교역로 1" },
        },
        reason: "FAVORITE",
      },
    ],
  ...
  http.get("/api/v1/stores/search", () => HttpResponse.json({
    items: [
      ...
      },
      {
        ...
        storeId: "10000000-0000-4000-8000-000000000003",
        name: "성수동점",
        customerDisplay: { ...customerDisplay, addressLine: "서울 성동구 연무장길 45" },
        matchedMenus: [{ menuId: ids.menu, name: "오트 라떼" }],
        brandName: "빈플로우",
        regionName: "성동구",
      },
      {
        ...
        orderingAvailable: false,
        pickupAvailable: false,
        customerDisplay: { ...customerDisplay, addressLine: "경기 성남시 분당구 판교역로 1", operatingStatus: "CLOSED" },
        matchedMenus: [],
        brandName: "빈플로우",
        regionName: "분당구",
      },
