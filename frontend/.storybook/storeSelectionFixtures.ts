...
export const storeSelectionHandler = http.get("/api/v1/operations/store-targets", () => HttpResponse.json({ items: [{ storeId: selectionStore.storeId, name: selectionStore.name }] }));
