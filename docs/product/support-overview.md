...
- API inventory: `docs/api/support-api-surface.md`; S20의 nine Case operations는 canonical OpenAPI에 구현됐고 이후
  typed Stage contract만 추가한다
- 구현 순서: `docs/exec-plans/active/customer-support-program-orchestration.md`와 상세 S20 plan
