...
> **Migration lane deferred (2026-08-12):** 사용자가 Support stack을 우선했고 completed S80이 V46을 검증한 뒤
> lease를 해제했다. 이 plan은 S100 Support stack completion과 lease release 뒤 latest Flyway 번호를 다시
> 확인하고 재번호화해야 하며 현재 migration branch/number/PR을 소유하지 않는다.
