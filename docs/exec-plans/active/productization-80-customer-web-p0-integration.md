...
> **Depends-On:** `docs/exec-plans/completed/productization-30-customer-account-and-login.md`, `docs/exec-plans/active/productization-50-customer-order-read-model.md`, `docs/exec-plans/active/productization-70-customer-store-discovery.md`
> **Completed-At:** `—`
