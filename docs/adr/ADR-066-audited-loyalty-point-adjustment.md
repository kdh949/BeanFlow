...
- **Schema prerequisite owner:** [Plan 10](../exec-plans/active/customer-order-cancellation-10-partial-refund-allocation-foundation.md)의 PointLot issuer snapshot precheck/migration
