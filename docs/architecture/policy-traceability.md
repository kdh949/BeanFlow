...
| BR-28 | Discovery Query Model, SignedCursorCodec | nearby search only, raw coordinate 비보존 | request-only coordinate; log redaction, raw range/micrometer keyset tuple | ADR-020, ADR-070 | Ready |
