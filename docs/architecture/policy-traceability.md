...
| BR-10 | PointAccount, PointLot/Reservation/Transaction, AuditRecord | 예약·사용·종료 복원과 OrderCompleted 적립, 감사형 수동 adjustment | source order/allocation/restoration/adjustment unique, signed effect, issuer/expiry conditional input, target Audit | ADR-011, ADR-028, ADR-041, ADR-042, ADR-066 | Ready |
...
| BR-20 | PointLot issuer cost, SettlementItem, AuditRecord | 포인트 비용 정산, Plan 10 만료 부분 환불 compensation과 수동 credit adjustment issuer snapshot | issuer type/reference immutable snapshot, Plan 10 legacy issuer precheck/migration gate, lot source tie-out, no default issuer | ADR-011, ADR-017, ADR-063, ADR-066 | Ready |
