...
| BR-03 | Order와 OrderLine option snapshot, 네 자원 Reservation | 주문 생성, terminal source의 빠른 재주문, PointLot 예약 시점 보장, `UNKNOWN`이어도 5분 만료; late approval은 void/refund | 현재 조건 전체 재검증, 한 로컬 tx, active source unique, guarded expiry/approval, 부분 재주문 금지 | ADR-004, ADR-005, ADR-011, ADR-013, ADR-077 | Fast reorder planned |
