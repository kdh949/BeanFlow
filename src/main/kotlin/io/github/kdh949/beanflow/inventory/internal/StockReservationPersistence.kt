...
internal interface SellableStockJpaRepository : JpaRepository<SellableStockEntity, UUID> {
	...
	fun findLockedById(@Param("id") id: UUID): SellableStockEntity?
}
...
internal interface StockReservationJpaRepository : JpaRepository<StockReservationEntity, UUID> {
	...
	fun findBySourceReferenceAndSellableUnitId(sourceReference: String, sellableUnitId: UUID): StockReservationEntity?
	...
	fun findLockedByOrderId(@Param("orderId") orderId: UUID): List<StockReservationEntity>
}
