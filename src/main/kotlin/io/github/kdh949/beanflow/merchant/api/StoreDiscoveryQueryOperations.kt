...
interface StoreDiscoveryQueryOperations {
     ...
     * `beanflow.discovery.search.index.coverage`, so the denominator is read by the module that
     * owns the store table rather than by a Discovery query against it.
     */
