...
internal interface MenuConfigurationRequirementJpaRepository :
	JpaRepository<MenuConfigurationRequirementEntity, UUID> {
	fun findAllByMenuConfigurationId(menuConfigurationId: UUID): List<MenuConfigurationRequirementEntity>
}
