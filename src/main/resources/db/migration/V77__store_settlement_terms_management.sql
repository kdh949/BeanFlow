...
INSERT INTO operations_audit_action_category (action, audit_category) VALUES
 ('STORE_SETTLEMENT_TERMS_REGISTERED', 'OPERATIONS_POLICY');
CREATE TABLE merchant_terms_command (
 id uuid PRIMARY KEY,
...
CREATE INDEX idx_terms_command_retention ON merchant_terms_command(created_at, id);
