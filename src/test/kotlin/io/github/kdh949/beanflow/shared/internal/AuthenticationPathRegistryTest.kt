    ...
    fun `every current and reserved endpoint belongs to exactly one chain`() {
        val expected =
            mapOf(
                ...
                "/api/v1/stores/00000000-0000-0000-0000-000000000001/menus/00000000-0000-0000-0000-000000000002/image" to
                ...
                "/api/v1/me/coupons" to AuthenticationChain.CUSTOMER,
                "/api/v1/me/events" to AuthenticationChain.CUSTOMER,
