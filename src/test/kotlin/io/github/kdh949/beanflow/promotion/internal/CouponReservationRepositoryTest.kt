...
@SpringBootTest
internal class CouponReservationRepositoryTest @Autowired constructor(
	...
	fun `rate coupon uses only eligible line subtotal and stores the quote`() {
		...
		val quote = transactions.execute {
			operations.reserve(
	...
	private fun command(fixture: CouponFixture, orderId: UUID, sourceReference: String) =
		ReserveCouponCommand(
			orderId = orderId,
			customerId = fixture.customerId,
			storeId = fixture.storeId,
